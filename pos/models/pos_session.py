...
class PosSession(models.Model):
    ...
    def _compute_cash_all(self):
        # Only one cash register is supported by pos.
        for session in self:
    ...
    def create(self, values):
        ...
        if self.user_has_groups('pos.group_pos_user'):
        ...
        update_stock_at_closing = pos_config.company_id.pos_update_stock_quantities == "closing"
    ...
    def _validate_session(self, balancing_account=False, amount_to_balance=0, bank_payment_method_diffs=None):
        bank_payment_method_diffs = bank_payment_method_diffs or {}
        self.ensure_one()
        sudo = self.user_has_groups('pos.group_pos_user')
    ...
    def get_closing_control_data(self):
        ...
        return {
            ...
            'is_manager': self.user_has_groups("pos.group_pos_manager"),
    ...
    def action_view_order(self):
        return {
            ...
            'view_mode': 'tree,form',
            'views': [
                (self.env.ref('pos.view_pos_order_tree_no_session_id').id, 'tree'),
                (self.env.ref('pos.view_pos_pos_form').id, 'form'),
                ],
            'type': 'ir.actions.act_window',
