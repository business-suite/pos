odoo.define('pos.tour.ProductScreen', function (require) {
    'use strict';

    const { ProductScreen } = require('pos.tour.ProductScreenTourMethods');
    const { TextAreaPopup } = require('pos.tour.TextAreaPopupTourMethods');
...
odoo.define('pos.tour.FixedPriceNegativeQty', function (require) {
    'use strict';
