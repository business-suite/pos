odoo.define('pos.ReceiptScreen', function (require) {
    ...
    const { Printer } = require('pos.Printer');
    const { is_email } = require('web.utils');
    const { useRef, useContext } = owl.hooks;
    const { useErrorHandlers, onChangeOrder } = require('pos.custom_hooks');
    const Registries = require('pos.Registries');
    const AbstractReceiptScreen = require('pos.AbstractReceiptScreen');
