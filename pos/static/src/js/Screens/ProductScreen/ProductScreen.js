odoo.define('pos.ProductScreen', function(require) {
    'use strict';

    const PosComponent = require('pos.PosComponent');
    const ControlButtonsMixin = require('pos.ControlButtonsMixin');
    const NumberBuffer = require('pos.NumberBuffer');
    const { useListener } = require('web.custom_hooks');
    const Registries = require('pos.Registries');
    const { onChangeOrder, useBarcodeReader } = require('pos.custom_hooks');
    const { isConnectionError, posbus } = require('pos.utils');
