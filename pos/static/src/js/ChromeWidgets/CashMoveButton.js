odoo.define('pos.CashMoveButton', function (require) {
    'use strict';
    ...
    class CashMoveButton extends PosComponent {
        async onClick() {
            ...
            if (this.env.pos.proxy.printer) {
                const renderedReceipt = this.env.qweb.renderToString('pos.CashMoveReceipt', {
    ...
    CashMoveButton.template = 'pos.CashMoveButton';
