odoo.define('pos.NumberPopupQuantity', function(require) {
    'use strict';
    ...
    // formerly NumberPopupQuantityWidget
    class NumberPopupQuantity extends AbstractAwaitablePopup {
        /**
         * @param {Object} props
    ...
    NumberPopupQuantity.template = 'NumberPopupQuantity';
    NumberPopupQuantity.defaultProps = {
        confirmText: _t('Ok'),
    ...
    Registries.Component.add(NumberPopupQuantity);

    return NumberPopupQuantity;
});
